...
<%@page import = "java.io.*"%>
        ...
        //세션으로 
            ...
            filePath = application.getRealPath("/hw3_online_store/member/" + id + ".txt");
            usingPath = application.getRealPath("/hw3_online_store/member/" + id + "_이용내역.txt");
